...
if(isset($_GET['search'])){
        ...
        $hasil = mysqli_query($koneksi, "select * from karyawan LEFT JOIN tbl_divisi ON karyawan.kd_divisi = tbl_divisi.id_divisi LEFT JOIN posisi ON karyawan.kd_posisi = posisi.id_posisi order by id desc limit $awaldata, $page");
