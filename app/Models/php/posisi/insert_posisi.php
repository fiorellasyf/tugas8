<?php 
	...
	$cek_jabatan="SELECT jabatan FROM posisi WHERE jabatan = '$posisi'";
	...
	<div class="container mt-3">
		...
		<form action="" method="post">
		  <div class="form-group row mt-3">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" name="posisi" value="<?= $posisi; ?>" placeholder="Masukkan Nama Posisi" required>
		    </div>
		  </div>
