    ...
    <div class="container mt-3">
        <div class="main">
            ...
            <nav class="navbar navbar-light bg-light justify-content-between mt-3">
                <a href="insert_posisi.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">+Tambah Data</a>
                        ...
                        <tr>
                            <th scope="row"><?php echo $no++; ?></th>
                                ...
                                <td><?php if ($sts == 1){ ?>
                                    ...
                                    <?php } ?></td>
                            <td>
                                <a href="update_posisi.php?id_posisi=<?php echo $row['id_posisi']; ?>" class="btn btn-success btn-sm active " role="button" aria-pressed="true"><i class="fas fa-edit"></i></a>
                                <?php if($sts == 0){ ?>
                                <a href="delete_posisi.php?id_posisi=<?php echo $row['id_posisi']; ?>" onclick="return confirm('Apakah anda yakin?');" class="btn btn-danger btn-sm active" role="button" aria-pressed="true"><i class="fas fa-trash-alt"></i></a>
                            <?php } ?>
                            </td>
                        </tr>
                      </tbody>
